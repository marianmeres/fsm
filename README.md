...
To integrate into your application, wrap this FSM in a layer that handles your business logic, orchestrates async operations, and calls `fsm.transition()` in response to events.
